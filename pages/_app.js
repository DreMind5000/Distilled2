...
function KryptoBirdMarketplace({ Component, pageProps }) {
  ...
  const navigation = [
    { name: "Main Marketplace ", href: "/", current: false },
    { name: "Mint Tokens", href: "/mint-item", current: false },
    { name: "My NFTS", href: "/my-nfts", current: false },
    { name: "Account Dashboard", href: "/account-dashboard", current: false },
  ];
                      ...
                      >
                        <p
                          className={classNames(
                            ...
                            "px-3 py-2 rounded-md text-sm font-medium text-white cursor-pointer "
                          )}
                        >
                          {" "}
                          {item.name}
                    ...
                    <p
                      className={classNames(
                        item.current
                          ? "bg-gray-900 text-white"
                          : "text-gray-300 hover:bg-gray-700 hover:text-white",
                        " text-white  px-3 py-2 rounded-md text-base font-medium  cursor-pointer"
                      )}
                    >
                      {" "}
                      {item.name}
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            ...
            <div className="grid grid-cols-2 gap-8 xl:col-span-4">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                ...
                <div className="mt-12 md:mt-0">
                  <h3 className="text-sm font-semibold text-indigo-600 tracking-wider uppercase">
                    Useful Links
                  </h3>
                  <ul role="list" className="mt-4 space-y-2">
                    {navigation.map((item) => (
                      <Link key={item.name} href={item.href}>
                        <li key={item.name}>
                          <div className="text-base text-gray-700 hover:text-gray-900 cursor-pointer">
                            {item.name}
                          </div>
                        </li>
                      </Link>
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul role="list" className="mt-4 space-y-2">
                    {fotterNavigation.company.map((item) => (
                      <li key={item.name}>
                        <a
                          href={item.href}
                ...
                <div className="mt-12 md:mt-0">
                  <div className="mt-12 xl:mt-0">
                    <h3 className="text-sm font-semibold text-indigo-500 tracking-wider uppercase">
                      Language &amp; Currency
                    </h3>
          ...
          <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
            <div className="flex space-x-6 md:order-2">
              {fotterNavigation.social?.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            ...
            <div className="grid grid-cols-2 gap-8 xl:col-span-4">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul role="list" className="mt-4 space-y-2">
                    <p className="text-base text-gray-400 hover:text-white">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                      Quis non, fugit totam vel laboriosam vitae.
                    </p>
                  </ul>
                ...
                <div className="mt-12 md:mt-0">
                  ...
                  <ul role="list" className="mt-4 space-y-2">
                    {fotterNavigation.support.map((item) => (
                      <li key={item.name}>
                        <a
                          href={item.href}
          ...
          <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
              &copy; 2021 NetStorm, All Rights Reserved.
            </p>
          </div>
        </div>
      </footer> */}
